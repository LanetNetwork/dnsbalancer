...
if (PKG_CONFIG_FOUND)
	pkg_check_modules(LIBLDNS REQUIRED ldns)
...
if (DS_HAVE_UAPI_EPOLLEXCLUSIVE)
	message("EPOLLEXCLUSIVE from sys/epoll.h will be used")
	set(DS_CONFIG_FLAGS "${DS_CONFIG_FLAGS} -DDS_HAVE_UAPI_EPOLLEXCLUSIVE")
elseif (DS_HAVE_KAPI_EPOLLEXCLUSIVE)
	message("EPOLLEXCLUSIVE from linux/eventpoll.h will be used")
...
if (DS_HAVE_UAPI_SO_REUSEPORT)
	message("SO_REUSEPORT from netinet/in.h will be used")
...
if (HAVE_DS_ATOMIC_SIZE_T)
	message("Compiler atomics are available and will be used")
	set(DS_CONFIG_FLAGS "${DS_CONFIG_FLAGS} -DDS_HAVE_ATOMICS")
else (HAVE_DS_ATOMIC_SIZE_T)
	message("Compiler atomics are not available, atomic_ops.h will be used")
